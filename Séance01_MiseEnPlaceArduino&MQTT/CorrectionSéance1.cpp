...
// Noms des topics
String subLED  = "isima/G1/LEDs/#";
String subBP   = "isima/G1/BPs/#";
String pubBP1  = "isima/G1/BPs/BP1";
String pubBP2  = "isima/G1/BPs/BP2";
String pubLED1 = "isima/G1/LEDs/LED1";
String pubLED2 = "isima/G1/LEDs/LED2";
...
void WifiConnect()
{
    ...
    WiFi.init(&Serial1);
    WiFi.begin((char*)"profan_b011","28893141");
}

void BrokerConnect()
{
    MQTTPacket_connectData configMQTT = MQTTPacket_connectData_initializer;       
    configMQTT.clientID.cstring = (char*)"GROUPE_1";
    configMQTT.username.cstring = (char*)"G1";
    configMQTT.password.cstring = (char*)"isimaG1";
    configMQTT.willFlag = 0;
    
    ipstack.connect((char *)"farmer-01.cloudmqtt.com",16753);
