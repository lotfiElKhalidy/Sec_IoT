...
/* Première partie : Utilisation du réseau local 

Idée : Se connecter au réseau local de cordonnées : SSID "ZZ_HSH"
        et mot de passe "..."

Résultat : En utilisant la commande AT+CWJAP?, on obtient :

13:36:08.756 -> >> AT+CWJAP?
13:36:08.793 -> +CWJAP:"ZZ_HSH","00:16:b6:b0:f8:33",6,-58
13:36:08.835 -> 
13:36:08.835 -> OK
13:36:08.835 -> ---------------------------------------------- > ZZ_HSH
...
void BrokerConnect() {
    ...
    ipstack.connect((char *)"m21.cloudmqtt.com",...);  // paramètres : adresseIP_du_broker et port
